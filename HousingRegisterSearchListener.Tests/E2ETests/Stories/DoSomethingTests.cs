using HousingRegisterSearchListener.Tests.E2ETests.Fixtures;
using HousingRegisterSearchListener.Tests.E2ETests.Steps;
using Hackney.Core.Testing.DynamoDb;
using System;
using TestStack.BDDfy;
using Xunit;

namespace HousingRegisterSearchListener.Tests.E2ETests.Stories
{
    [Story(
