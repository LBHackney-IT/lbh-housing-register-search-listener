# HousingRegisterSearchListener.Tests

This is the test project for the HousingRegisterSearchListener application.
...
See the [BaseSteps class](/HousingRegisterSearchListener.Tests/E2ETests/Steps/BaseSteps.cs) for more details.
